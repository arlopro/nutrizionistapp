...
function submit() {
    form.post(route('nutritionist.foods.store'));
}
</script>

<template>
    <Head title="Nuovo Alimento" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-xl font-semibold text-gray-900">Nuovo Alimento</h1>
            </div>
        </template>
        ...
        <form @submit.prevent="submit" class="max-w-2xl">
            ...
            <div class="rounded-2xl bg-white border border-gray-100 shadow-sm p-6 mb-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
                    <div>
                        ...
                        <InputError :message="form.errors.calories_per_100g" class="mt-1" />
                    </div>
                    <div>
                        ...
                        <InputError :message="form.errors.protein_per_100g" class="mt-1" />
                    </div>
                    <div>
                        ...
                        <InputError :message="form.errors.carbs_per_100g" class="mt-1" />
                    </div>
                    <div>
                        ...
                        <InputError :message="form.errors.fat_per_100g" class="mt-1" />
                    </div>
                    <div>
            ...
            <div class="flex items-center gap-3">
                <PrimaryButton :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Salva Alimento</PrimaryButton>
